...
<div class="container">
  <div class="row">
    <div class="col">
    	...
    	<h1>Cadastro de sentimentos para músicas:</h1>
  ...
  <form method="POST" action="proc_cad_musicasentimento.php">
      <label>Músicas:</label><br>
<input name="musicas" id="mus" list="musicas" required>
<datalist id="musicas">

<?php include("conexao.php");
try{
  $musicas= $connect->prepare("SELECT id_musicas,nome_musica FROM musicas");
  $musicas->execute();

  foreach ($musicas as $row){
  echo "<option value=".$row['id_musicas'].">".$row['nome_musica']."</option>";
  }}
...
<button class="btn btn-primary" name='register' type="submit">Ligar ao sentimento</button>
